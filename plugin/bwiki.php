...
function b_BopComments_bwiki($maxtopic)
{
    global $xoopsConfig;
    ...
    foreach ($recent as $line) {
        ...
        $key = BopComments_KeyCheck($comment, $time + ($xoopsConfig['server_TZ']) * 3600);

        $comment[$key]['moduleimg'] = XOOPS_URL . '/modules/BopComments/plugin/image/bwiki.gif';
